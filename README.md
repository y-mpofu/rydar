# Navigation and Discovery for Informal Transport

## Overview
Rider-first, driver-protecting project that makes multi-leg journeys predictable, safer, and more profitable. Layers on existing behavior: walk to junction, wait, hop on, transfer. Project partners: y-mpofu, siisodaa, uosondu
